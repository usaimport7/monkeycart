...
# スプレッドシートを開く
spreadsheet = client.open("soraiemonkeycart")  # スプレッドシートの名前に応じて変更してください
sheet = spreadsheet.sheet1  # シート名に応じて変更してください

# データをスプレッドシートに書き込む
def write_to_spreadsheet(data):
    sheet.append_row(data)

# 例として、ユーザーの入力をスプレッドシートに書き込む
user_input_data = ["First Name", "Last Name", "Address", "License Number", "Country", "Mobile Number", "Email Address", "Preferred Date", "Preferred Timeslot", "Number of People"]
write_to_spreadsheet(user_input_data)